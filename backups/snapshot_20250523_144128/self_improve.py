...
class SelfImproveEngine:
    ...
    def run_cycle(self):
        ...
        prompt = (
    "Based on the Python code provided above, generate ONLY a unified diff (GitHub style) that implements the pending feature requests. "
    "Do NOT include any analysis, explanation, or commentary—only the raw diff lines."
    )
