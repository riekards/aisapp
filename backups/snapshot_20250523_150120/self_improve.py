...
class SelfImproveEngine:
    ...
    def run_cycle(self):
        ...
        prompt = (
            context_str +
            "\nBased on the code above and requested features, generate ONLY a unified diff (GitHub style) applying to .py files under app/. "
            "Include file creations or modifications as needed, and include pytest tests. "
            "DO NOT include commentary or fences—only raw diff lines." +
            feature_text
        )
